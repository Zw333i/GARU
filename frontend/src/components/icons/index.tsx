...
export const MaskIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2C6.48 2 2 6 2 11c0 2.76 1.68 5.18 4.19 6.5L5 22l4-2.5c.93.32 1.94.5 3 .5s2.07-.18 3-.5l4 2.5-1.19-4.5C21.32 16.18 23 13.76 23 11c0-5-4.48-9-11-9zm-4 8c-.83 0-1.5-.67-1.5-1.5S7.17 7 8 7s1.5.67 1.5 1.5S8.83 10 8 10zm8 0c-.83 0-1.5-.67-1.5-1.5S15.17 7 16 7s1.5.67 1.5 1.5S16.83 10 16 10z" />
  </svg>
)
...
export const HandshakeIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 5.36L8.87 8.5a2.13 2.13 0 0 0 0 3l.94.95a2.13 2.13 0 0 0 3 0l2.19-2.2a2.13 2.13 0 0 1 3 0l.95.95" />
  </svg>
)
