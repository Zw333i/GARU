// SVG Icons for GARU - All emojis replaced with clean SVGs
...
// Scale/Compare icon
export const CompareIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const FireIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 23c-3.866 0-7-3.134-7-7 0-2.577 1.385-4.873 3.477-6.21.49-.313 1.149.073 1.092.648-.162 1.634.396 3.37 1.67 4.645.38.38.886.487 1.328.353.443-.135.772-.486.851-.94.206-1.184.734-2.273 1.555-3.168 1.953-2.128 3.028-4.917 2.95-7.833-.018-.668.81-1.012 1.298-.534C21.145 5.036 23 8.747 23 12.5c0 5.799-4.925 10.5-11 10.5z" />
    <path d="M12.857 23c-2.253 0-4.108-1.926-4.108-4.278 0-1.502.808-2.841 2.029-3.62.286-.183.671.043.638.379-.095.953.231 1.965.974 2.71.222.221.518.284.776.206.26-.079.451-.284.498-.548.12-.69.429-1.326.909-1.847 1.14-1.241 1.768-2.867 1.722-4.567-.011-.39.473-.59.758-.312 1.273 1.238 2.055 3.163 2.055 5.353 0 3.38-2.876 6.124-6.251 6.124z" fill="currentColor" fillOpacity="0.6" />
  </svg>
)
...
export const BasketballIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M14.83 9.17a18 18 0 0 1 4.65-4.65" />
    <path d="M9.17 14.83a18 18 0 0 1-4.65 4.65" />
    <path d="M4.93 19.07A10 10 0 0 1 2.34 14" />
    <path d="M19.07 4.93A10 10 0 0 1 21.66 10" />
  </svg>
)
...
export const LeaderboardIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 15l-2 5-5 1 4-4-1-5 4 3 4-3-1 5 4 4-5-1-2-5z" />
    <circle cx="12" cy="8" r="5" />
  </svg>
)

// Swords/Battle icon
export const SwordsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const CrownIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M2.5 19h19v2h-19v-2zm19.26-9.98l-2.51 10.98H4.75L2.24 9.02l6.76 3.38L12 5l3 7.4 6.76-3.38z" />
  </svg>
)

// Medal icons for leaderboard
export const GoldMedalIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none">
    <circle cx="12" cy="14" r="7" fill="#FFD700" stroke="#DAA520" strokeWidth="1" />
    <path d="M8 3h8l-1.5 4h-5L8 3z" fill="#FFD700" stroke="#DAA520" strokeWidth="0.5" />
    <text x="12" y="17" textAnchor="middle" fill="#DAA520" fontSize="8" fontWeight="bold">1</text>
  </svg>
)

export const SilverMedalIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none">
    <circle cx="12" cy="14" r="7" fill="#C0C0C0" stroke="#A0A0A0" strokeWidth="1" />
    <path d="M8 3h8l-1.5 4h-5L8 3z" fill="#C0C0C0" stroke="#A0A0A0" strokeWidth="0.5" />
    <text x="12" y="17" textAnchor="middle" fill="#707070" fontSize="8" fontWeight="bold">2</text>
  </svg>
)

export const BronzeMedalIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none">
    <circle cx="12" cy="14" r="7" fill="#CD7F32" stroke="#8B4513" strokeWidth="1" />
    <path d="M8 3h8l-1.5 4h-5L8 3z" fill="#CD7F32" stroke="#8B4513" strokeWidth="0.5" />
    <text x="12" y="17" textAnchor="middle" fill="#8B4513" fontSize="8" fontWeight="bold">3</text>
  </svg>
)

// Baby/First Steps icon
export const BabyIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6z" />
    <path d="M12 8c-3.5 0-6 2-7 4.5" />
    <path d="M19 12.5c-1-2.5-3.5-4.5-7-4.5" />
    <path d="M8 21l2-6" />
    <path d="M16 21l-2-6" />
    <path d="M9 15h6" />
  </svg>
...
export const ConfettiIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M5.8 2.4L7 7l4.6-1.2L6.2 2c-.3-.2-.5.1-.4.4zM4 13l1-4L1.7 8.2c-.3 0-.4.3-.2.5L4 13zM6.2 22c.3.2.5-.1.4-.4L5.8 16 1.2 17.2c-.3.1-.4.3-.2.5L6.2 22zM8 11l-1 4 3.3.8c.3 0 .4-.3.2-.5L8 11zM18.2 2L13.6 5.8 17 7c.3.1.5-.1.4-.4L18.2 2zM22.3 8.2L19 9l1 4 2.5-4.3c.2-.2 0-.5-.2-.5zM20 16l-4.6 1.2 4.4 4.5c.2.2.5 0 .5-.2L20 16zM16 15l-3.3-.8c-.3 0-.4.3-.2.5l2.5 4.3 1-4z" />
